...
import com.foody.controller.CartController;
import com.foody.controller.FoodController;
import com.foody.controller.LoginController;
import com.foody.controller.RegistrationController;
...
public class ApiTests {
    ...
    public void postRegisterAPI() throws Exception
    {
        mvc.perform( MockMvcRequestBuilders
                .post("/register")
                .content(asJsonString(new User("vigi","abcd1234","bbbb","bbbb","b@gmail.com","bbbb",Long.valueOf(1234),true)))
    ...
    public void postCheckUsernameApi() throws Exception{
        mvc.perform( MockMvcRequestBuilders
                .post("/checkUserName")
                .content("vigi").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
    }
